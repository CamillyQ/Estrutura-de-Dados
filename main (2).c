...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            {
            case 1:
                inserir_por_arquivo(g1, "C:\\Users\\Camilly Perfeita\\Desktop\\estrutura_de_dados\\pcv4.txt");
                ...
                break;
            case 2:
                inserir_por_arquivo(g2, "C:\\Users\\Camilly Perfeita\\Desktop\\estrutura_de_dados\\pcv10.txt");
                printf("Insira o inicio: ");
                scanf("%d", &init);
                printf("Insira o destino: ");
                scanf("%d", &finish);
                ...
                break;
            case 3:
                inserir_por_arquivo(g3,  "C:\\Users\\Camilly Perfeita\\Desktop\\estrutura_de_dados\\pcv55.txt");
                printf("Insira o inicio: ");
                scanf("%d", &init);
                printf("Insira o destino: ");
                scanf("%d", &finish);
                ...
                break;
            case 4:
                inserir_por_arquivo(g4, "C:\\Users\\Camilly Perfeita\\Desktop\\estrutura_de_dados\\pcv177.txt");
                printf("Insira o inicio: ");
                scanf("%d", &init);
                printf("Insira o destino: ");
                scanf("%d", &finish);
        ...
        case 2:
            ...
            case 1:
                inserir_por_arquivo(g1, "C:\\Users\\Camilly Perfeita\\Desktop\\estrutura_de_dadosOS\\pcv4.txt");
                printf("Insira o inicio: ");
                scanf("%d", &init);
                dsf(g1, init);
                break;
